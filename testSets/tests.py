...
def test1():
    ...
    rede.addLevada(Levada(s1, s2, 1))
    rede.addLevada(Levada(s1, s3, 2))
    rede.addLevada(Levada(s2, s4, 3))
    rede.addLevada(Levada(s2, s5, 3))
    rede.addLevada(Levada(s4, s6, 4))
    rede.addLevada(Levada(s5, s7, 9))
    rede.addLevada(Levada(s6, s7, 5))
    rede.addLevada(Levada(s3, s7, 4))
    rede.addLevada(Levada(s1, s8, 5))
    rede.addLevada(Levada(s8, s7, 4))
...
def test2():
    ...
    rede.addLevada(Levada(s1, s8, 5))
    rede.addLevada(Levada(s8, s7, 4))
    rede.addLevada(Levada(s9, s10, 4))
